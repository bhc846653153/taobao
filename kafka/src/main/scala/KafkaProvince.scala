...
object KafkaProvinceCount {
  def main(args: Array[String]): Unit = {
    // 1.初始化Spark配置信息
    val sparkconf: SparkConf=new SparkConf().setAppName("KafkaProvinceCount")
    ...
    val wordCounts = words.updateStateByKey(
      ...
      if(rdd.count !=0 ){
        ...
        val message = new ProducerRecord[String, String]("province_result", null, str)
        // 给Kafka发送消息
